...
//       priceFrom: request.nextUrl.searchParams.get('priceFrom') || '',
//       priceTo: request.nextUrl.searchParams.get('priceTo') || '',
//       size: request.nextUrl.searchParams.get('size') || '',
//       type: request.nextUrl.searchParams.get('type') || '',
//     };

//     // Fetch properties based on filters if any
//     const isSearching = Object.values(filters).some(filter => filter);

//     console.log("PROPERTIES_IS_SEARCHING", isSearching)

//     let properties = [];
//     if (isSearching) {
//       // If there are search filters, use the search function
//       properties = await searchProperties(filters);
//       console.log("PROPERTIES_IS_SEARCHING", properties);
//     } else {
//       // If no filters, fetch properties normally
//       properties = await Property.find({}).skip(skip).limit(pageSize);
//       console.assert("PROPERTIES_FIND_PAGE_SIZE", properties)
//     }

//     const total = await Property.countDocuments({});
//     console.assert("PROPERTIES_TOTAL", total)
//     const result = {
//       total,
...
//         type: property.type || "Property type not provided",
//         category: property.category || "Property category not provided",
...
// // GET /api/properties ---OLD WORKING GET PROPERTIES
// // export const GET = async (request) => {
// //   try {
// //     await connectDB();

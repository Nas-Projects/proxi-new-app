...
import { searchProperties } from '../../lib/searchProperties'; // Import the search function

// import PropertyCard from '@/components/cards/PropertyCard';
import Filters from '@/components/Filters';
// Reusable PropertyCard component
const PropertyCard = ({ property }) =>{  
  // console.log("PROPERTIESS_CARD: " , property)
  return  (
...
const PropertiesPage = () => {
  ...
  useEffect(() => {
    const fetchProperties = async () => {
      try {
        setLoading(true);
        const response = await fetch(`/api/properties?page=1&pageSize=10&${new URLSearchParams(filters)}`);

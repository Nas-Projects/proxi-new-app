...
import User from '@/models/User'; // Adjust the import path as needed
 ...
 export async function fetchUserById(id: string) {
  ...
  try {
    ...
    // Serialize the user data if necessary
    return {
      ...user,
...
//  import { UserProfileMongoDBWithExtras, UserPost } from './types'; // Adjust the path accordingly

//  export async function fetchUserById(id: string): Promise<UserProfileMongoDBWithExtras> {
//    await connectDB();
...
//      const serializedUser: UserProfileMongoDBWithExtras = {
//        ...user,
//        _id: user._id.toString(),
...
//          created_at: post.createdAt ? post.createdAt.toISOString() : '',
//          updated_at: post.updatedAt ? post.updatedAt.toISOString() : '',
//        })) as UserPost[],
//        // Include other fields as needed
//      };
...
//    } catch (error) {
//      console.error('Database Error in fetchUserById:', error);

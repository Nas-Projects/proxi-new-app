...
import { CheckInCircleIcon, CheckIcon, GitHubIcon, LoadingDots, UploadIcon, XIcon } from '@/components/nassersIcons';
...
export default function Profile({
  ...
  return (
    <div className="min-h-screen pb-20">
      <div>
        <div className={`h-48 w-full lg:h-64 ${getGradient(user.username || user?.name)}`} />

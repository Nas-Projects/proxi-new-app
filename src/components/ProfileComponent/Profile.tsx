...
import { UserProps } from '@/lib/api/apiHelper';
import {CheckInCircleIcon,
CheckIcon,
EditIcon,
GitHubIcon,
LoadingDots,
            ...
            >
              ...
              <div className="mt-6 sm:flex-1 sm:min-w-0 sm:flex sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
                ...
                {user?.verified ? (
                    ...
                    <a target="_blank" rel="noopener noreferrer" className="inline-flex justify-center px-4 py-2 border border-gray-800 hover:border-white shadow-sm text-sm font-medium rounded-md text-white font-mono bg-black focus:outline-none focus:ring-0 transition-all" href="https://github.com/vercel/mongodb-starter">
                      <GitHubIcon /><span>View Instagram Account</span>
                      </a>
                      <Link
                      ...
                      >
                        ...
                        <h3 className='text-white flex'>View GitHub Profile</h3>
                      </Link>
                    </div>
                  ) : ( 
                    <div className="mt-6 flex flex-col justify-stretch space-y-3 sm:flex-row sm:space-y-0 sm:space-x-4">
                      ...
                      >
                        <GitHubIcon className="mr-3 h-5 w-5 text-white" />
                        <span className="text-white flex">{user.license}</span>
                      </a>
                    </div>
                  )}
              </div>

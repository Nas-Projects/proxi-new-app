  ...
  return (
    ...
    >
      ...
      <div className="inner h-[2em] max-[490px]:mt-[12px] sm:grid sm:grid-cols-6">
        ...
        <div className={`logo px-8 sm:px-[4%] sm:col-span-2 pt-3 !max-w-sm  ${isScrollingUp ? 'sm:flex pt-[0.2%]' : 'lg:!py-[0.2%]'}`}>
        {/* <Link href="/" onClick={handleNavItemClick}>
          ...
          <Link href="/" onClick={handleNavItemClick}>
            {isTop ? (
              <h1 className="text-white text-7xl flex max-w-[30vw] py-[3.2%]">
                PROXY <br /> 
              </h1>
            ) : (
        ...
        <div className={clsx(`px-4 sm:!px-0 sm:col-span-4  max-[490px]:flex sm:px-0 bg-[#2c2c2c80] relative  ${isScrollingUp ? applyStyle  : baseStyle}  ${isTop && baseStyle} ${isTop && 'bg-[#1c1a1a] ' } ${isSocialVisible && '!bg-[#2b2829]'}`)}>
          <nav 
          className={clsx(`nav nav--primary ${isTop && 'py-[15px]' }`)}
          ...
          >
            ...
            //  style={{ transition: '.4s'}}
              ...
              className={`absolute nav__toggle dark:!text-white !px-[1em] !py-0  lg:py-[10px] lg:!top-[-72%] before:text-white ${isScrollingUp && '!top-[-5.3em]'} ${isTop && '!top-[-3.2em]'}`}
            >
              <span className=''/>
            ...
            <div id="MOBILE_NAV_OPEN" className={clsx(`nav__wrapper nav__wrapper--active !overflow-y-hidden ${isNavOpen ? '!bg-[#0c0c0c]': ''}`)} > 
              ...
              <div  className={clsx(`w-full flex-block ${isScrollingUp ?  'max-[640px]:!mt-[8em]  lg:!pt-[3%]'  : " !pb-[4%] lg:!pt-[0%] lg:grid "} ${isSocialVisible ? 'lg:!py-[2.6%]' : 'lg:!py-[1%]'} `)} style={{ transition: '2s !important' }}>
        ...
        {/* <ChevronDownIcon className="ml-3  h-auto w-2 stroke-zinc-500 group-hover:stroke-zinc-700" /> */}
               ...
               <div className="block max-[490px]:mt-[3vh] !z-50 ">
                <ul id="menu-primary-navigation" className="menu dark:!text-white sm:flex  w-full group" >
                  ...
                  <MobileNavItem  key={index} href={navlink.href} handleNavItemClick={handleNavItemClick} classN={'flex h-[89px] lg:h-[2.9rem]  lg:pt--[.9rem]    lg:mt-[-20px] max-[640px]:bg-black  !mb-4 '} textStyle={'dark:text-[var(--themeColorGray1)]'} activeColor={'!text-white'}>{navlink.name} </MobileNavItem>)}
                {/* <li
...
<div className={clsx(isTop &&  "border-t border-[#ffffff25]", "paradigms  w-full groupmax-[640px]:py-0 max-[640px]:pb-4  sm:pt-[2.5%] sm:h-24")}>

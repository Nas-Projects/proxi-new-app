  ...
  const allPosts: Post[] = [
    ...posts.map((post) => ({
      ...
      author: {
        ...
        role: "Founder", // Provide a default role if needed
        href: "#", // Provide a default link if needed
        image: post.author?.image || { asset: { url: "/default-avatar.png" } }, // Fallback to default avatar if image is missing
        bio: post.author?.bio || "", // Ensure bio exists
        email: post.author?.email || "No email provided", // Ensure email exists
        socialLinks: post.author?.socialLinks || [], // Ensure social links exist
      },

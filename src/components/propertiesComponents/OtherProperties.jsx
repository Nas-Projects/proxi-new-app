      ...
      <div role="list" className="houe-grid w-dyn-items">
        ...
        <div role="listitem" className="collection-item w-dyn-item">
          <a
            style={{
              backgroundImage:
                'url("https://cdn.prod.website-files.com/63c93770199def226e7204f3/63c93770199def243a7204f9_property-thumnail%201-min.jpg")'
            }}
            href="/properties/dragonveien-1"
            className="house-card w-inline-block"
          >
            <div className="house-content">
              <div className="house-title">Dragonveien 1</div>
              <div className="house-card-divider" />
              <div className="house-detail-wrap">
                <div className="detail-block white-block">
                  <div className="icon paragraph-small">
                  ...
                  <p className="paragraph-small">Tromsø</p>
                </div>
                <div className="detail-block white-block">
                  <div className="icon paragraph-small">
                    <img
                  ...
                  <div className="wrap-detail-value">
                    <p className="paragraph-small">120</p>
                    <p className="paragraph-small">m2</p>
                  </div>
                </div>
              </div>
        ...
        <div role="listitem" className="collection-item w-dyn-item">
          <a
            style={{
              backgroundImage:
                'url("https://cdn.prod.website-files.com/63c93770199def226e7204f3/63c93770199defb61072050b_property-thumnail%202-min.jpg")'
            }}
            href="/properties/storgata-15"
            aria-current="page"
            className="house-card w-inline-block w--current"
          >
            <div className="house-content">
              <div className="house-title">Storgata 15</div>
              <div className="house-card-divider" />
              <div className="house-detail-wrap">
                <div className="detail-block white-block">
                  <div className="icon paragraph-small">
                  ...
                  <p className="paragraph-small">Oslo</p>
                </div>
                <div className="detail-block white-block">
                  <div className="icon paragraph-small">
                    <img
                  ...
                  <div className="wrap-detail-value">
                    <p className="paragraph-small">210</p>
                    <p className="paragraph-small">m2</p>
                  </div>
                </div>
              </div>
